...
isKabisat :: Int -> Bool
isKabisat t = (t `mod` 400 == 0) || ((t `mod` 4 == 0) && (t `mod` 100 /= 0))
...
isValid :: Tanggal -> Bool
isValid (Tanggal h b t) = (t >= 1) && (b >= 1 && b <= 12) && (h >= 1 && h <= hariDalamBulan b t)

isEqTanggal :: Tanggal -> Tanggal -> Bool
isEqTanggal (Tanggal h1 b1 t1) (Tanggal h2 b2 t2) = 
  if isValid (Tanggal h1 b1 t1) && isValid (Tanggal h2 b2 t2) then
    (h1 == h2) && (b1 == b2) && (t1 == t2)
  else
    False
