...
/* Versi II : dengan banyaknya elemen didefinisikan secara eksplisit,
   ...
   void CreateListDin(ListDin *l, int capacity){
    l->capacity = capacity;
    l->buffer = (ElType*)malloc(l->capacity* sizeof(int));
    l->nEff=0;
   }
   ...
   boolean isIdxValid(ListDin l, IdxType i){
    if(i>=0 && i<l.capacity) return true;
    return false;
   }
   /* Mengirimkan true jika i adalah indeks yang valid utk kapasitas list l */
   /* yaitu antara indeks yang terdefinisi utk container*/
   boolean isIdxEff(ListDin l, IdxType i){
    if(i>=0 && i<l.nEff) return true;
    return false;
   }
   ...
   boolean isEmpty(ListDin l){
    if(l.nEff ==0 ) return true;
    return false;
   }
   /* Mengirimkan true jika list l kosong, mengirimkan false jika tidak */
   /* *** Test list penuh *** */
   boolean isFull(ListDin l){
    if(l.nEff==l.capacity) return true;
    return false;
   }
   ...
   void expandList(ListDin *l, int num){
    l->capacity += num;
    l->buffer = (ElType*) realloc(l->buffer,l->capacity * sizeof(int)) ;
   }
