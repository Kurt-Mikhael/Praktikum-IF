...
int isLeapYear(int year) {
    if ((year % 4 == 0 && year % 100 != 0 && year % 400 != 0) || (year % 400 == 0)) return 1;
    return 0;
}
...
const char* getPasaran(int day, int month, int year) {
    ...
    return pasaran[(daysFromBeginning(day, month, year) + 1) % 5];
...
int main() {
    ...
    char input[100];
    scanf("%s",input);
    while (strcmp(input,"SELESAI\0" )!=0){
        if (strcmp(input, "VALIDASI") == 0) {
        ...
        else if (strcmp(input,"HARI")==0){
            scanf("%d %d %d",&d1,&m1,&y1);
            printf("%s\n",getDayOfWeek(d1,m1,y1));
        }
        else if (strcmp(input,"ZODIAK")==0){
            scanf("%d %d",&d1,&m1);
            printf("%s\n",getZodiac(d1,m1));
        }
        else if (strcmp(input,"SELISIH")==0){
            int d2,m2,y2 ;
            scanf("%d %d %d %d %d %d",&d1,&m1,&y1,&d2,&m2,&y2);
            printf("%lld\n",dateDifference(d1,m1,y1,d2,m2,y2));
        }
        else if (strcmp(input,"PASARAN")==0){
            scanf("%d %d %d",&d1,&m1,&y1);
            printf("%s\n",getPasaran(d1,m1,y1));
        }
        scanf("%s",input);
